	...
	app: {
		...
		head: {
			...
			script: [
				...
				{ src: '/vue-education-9e0354/js/bootstrap.bundle.js' },
				{ src: '/vue-education-9e0354/js/bootstrap.js' },
				{ src: '/vue-education-9e0354/js/boardReadPage.js' },
				{ src: '/vue-education-9e0354/js/mainlnb.js' },
			],
		},
	},
